    ...
    <div class="l-sidebar__content">
      <nav class="c-menu js-menu">
        <ul class="u-list">
          ...
          <li class="c-menu__item has-submenu" data-toggle="tooltip" title="Broadcast">
            <div class="c-menu__item__inner"><i class="far fa-envelope"></i>
              <div class="c-menu-item__title"><span>Broadcast</span></div>
            </div>
          </li>
